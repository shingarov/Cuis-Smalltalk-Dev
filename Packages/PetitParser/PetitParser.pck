'From Cuis 5.0 of 7 November 2016 [latest update: #3222] on 27 November 2017 at 2:47:12 pm'!
'Description Please enter a description for this package '!
!provides: 'PetitParser' 1 1!
...
!PPCharSetPredicate methodsFor: 'initialization' stamp: 'ck 11/27/2017 14:22:36'!
initializeOn: aBlock	block := aBlock.	classification := Array new: 255.	1 to: classification size do: [ :index |		classification at: index put: (block			value: (Character numericValue: index)) ]! !

!PPCharSetPredicate methodsFor: 'evaluating' stamp: 'ck 11/27/2017 14:24:32'!
value: aCharacter	| index |	index := aCharacter numericValue.	index == 0		ifTrue: [ ^ block value: aCharacter ].	index > 255		ifTrue: [ ^ block value: aCharacter ].	^ classification at: index! !
...
!PPPredicateObjectParser class methodsFor: 'factory-chars' stamp: 'ck 11/27/2017 14:45:52'!
